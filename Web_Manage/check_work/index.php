...
$col[] = array('column' => $colname['corp'], 'name' => '公司名稱', 'order' => true, 'width' => '150');
$col[] = array('column' => $colname['title'], 'name' => '內容', 'order' => true, 'width' => '150');
        ...
        $('#table1').coderlisthelp({
            debug: true, callback: function (obj, rows) {
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    $tr.append('<td>' + row["<?php echo $colname['corp'];?>"] + '</td>');
