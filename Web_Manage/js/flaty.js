...
//	$.Window.bind($.Events.resizeNicescroll, resizeNicescroll);	
    ...
    //Submenu dropdown
    $(document).on('click','#sidebar a.dropdown-toggle',function() {
    ...
    $(document).on('click','#nav-horizontal a.dropdown-toggle',function() {
    ...
    //----------------------- Chosen Select ---------------------//
    if (jQuery().chosen) {
        $(".chosen").chosen({no_results_text: "找不到任何項目!"});
